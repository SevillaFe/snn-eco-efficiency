...
if __name__ == "__main__":
    ...
    h5_dir_rate = '.../Udacity_Dataset/Encoded_Images/Rate/Encoded_Datasets'
...
#
    ...
    output_dir_rate = '.../Udacity_Dataset/Encoded_Images/Rate/Emissions/Emissions_model/LaskNet'
    #output_dir_latency = '.../Udacity_Dataset/Encoded_Images/Latency/Emissions/Emissions_model/LaskNet'
    #output_dir_delta = '.../Udacity_Dataset/Encoded_Images/Delta/Emissions/Emissions_model/LaskNet'
    ...
    logger_name = f"SNN_LaskNet_Udacity_{h5_file_rate.split('_', 3)[-1].replace('.h5', '')}"
