...
if __name__ == "__main__":
    ...
    h5_file_rate = 'encoded_dataset_rate_numsteps_5_gain_0.5.h5'
...
#
    ...
    output_dir_rate = '.../PaloAlto_Dataset/Encoded_Images/Rate/Emissions/Emissions_model/PilotNet'
    #output_dir_latency = '.../PaloAlto_Dataset/Encoded_Images/Latency/Emissions/Emissions_model/PilotNet'
    #output_dir_delta = '.../PaloAlto_Dataset/Encoded_Images/Delta/Emissions/Emissions_model/PilotNet'
    ...
    logger_name = f"SNN_PilotNet_PaloAlto_{h5_file_rate.split('_', 3)[-1].replace('.h5', '')}"
